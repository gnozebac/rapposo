    ...
    public partial class respaldar : Form
    {
        ...
        private void GetDB_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strConnection = "Server=localhost;Port=" + strPort + ";Database=postgres;Userid=postgres;Password=sistemas;";
        ...
        private void butBackupFilePath_Click_1(object sender, EventArgs e)
        {
            try
            {
